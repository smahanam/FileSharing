...
PIDS=()
mpirun -np 288 --map-by socket:PE=48 --bind-to none ./LIS -f input/lis.config_files/CanESM5/lis.config.s2sglobal.noahmp401.hymap2.da_ics_forecast_CanESM5_202502_00 &
PIDS+=($!)
