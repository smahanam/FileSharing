...
#SBATCH --output /discover/nobackup/projects/ghilis/S2S/GLOBAL/FileSharing/E2ESDIR/scratch/202501/lis_fcst/lis_fcst_GFDL_04_%j.out
#SBATCH --error /discover/nobackup/projects/ghilis/S2S/GLOBAL/FileSharing/E2ESDIR/scratch/202501/lis_fcst/lis_fcst_GFDL_04_%j.err
...
srun --mpi=pmi2 --ntasks=$SLURM_NTASKS \
     ...
     --cpu-bind="none"  \
     ./LIS -f input/lis.config_files/GFDL/lis.config.s2sglobal.noahmp401.hymap2.da_ics_forecast_GFDL_202501_04 || exit 1
