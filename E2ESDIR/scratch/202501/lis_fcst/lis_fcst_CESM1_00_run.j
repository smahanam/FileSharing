...
#SBATCH --job-name=lis_fcst_CESM1_00_
#SBATCH --output /discover/nobackup/projects/ghilis/S2S/GLOBAL/FileSharing/E2ESDIR/scratch/202501/lis_fcst/lis_fcst_CESM1_00_%j.out
#SBATCH --error /discover/nobackup/projects/ghilis/S2S/GLOBAL/FileSharing/E2ESDIR/scratch/202501/lis_fcst/lis_fcst_CESM1_00_%j.err

#######################################################################
#                  Run LISF S2S lis_fcst_CESM1_00_
#######################################################################
...
srun --mpi=pmi2 --ntasks=$SLURM_NTASKS \
     ...
     --cpu-bind="none"  \
     ./LIS -f input/lis.config_files/CESM1/lis.config.s2sglobal.noahmp401.hymap2.da_ics_forecast_CESM1_202501_00 || exit 1

echo "[INFO] Completed lis_fcst_CESM1_00_!"
